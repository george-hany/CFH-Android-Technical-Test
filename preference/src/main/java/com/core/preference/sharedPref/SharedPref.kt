...
import com.core.preference.PreferencesKeys.Companion.email
...
constructor(
    ...
    fun saveUserEmail(value: String?) {
        mPrefs.edit().putString(email.name, value).apply()
    }

    fun getUserEmail() = mPrefs.getString(email.name, null)
}
